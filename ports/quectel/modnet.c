...
#if 0//defined(PLAT_ASR_1606) || defined(PLAT_ASR_1609)
static mp_obj_t qpy_net_get_cell_info_ex(mp_obj_t simid)
{
	int i = 0;
	int ret = 0;
	mp_obj_t list_gsm  = mp_obj_new_list(0, NULL);
    ...
    int cur_simid = mp_obj_get_int(simid);
    if ((cur_simid != 0) && (cur_simid != 1))
    {
...
static MP_DEFINE_CONST_FUN_OBJ_1(qpy_net_get_cell_info_ex_obj, qpy_net_get_cell_info_ex);
#endif
